        ...
        <main class="py-4">
            ...
            <div class="message_container py-3 m-auto">
                <div class="row justify-content-between mx-4">
                    <h3 class="fw-bold col-11">{{$posts[0]['name']}}の投稿内容</h3>
                ...
                <div class="message_box p-1 my-2 mx-auto">
                    ...
                    <div class="post_box m-1">
                        <div class="post_info">
                            <!-- ユーザ名 -->
                            <a href="/edit/{{ $post['id'] }}" class="message_content large mx-1 text-decoration-none">{{ $post['name'] }}</a>
                            <!-- 投稿時間 -->
                            <p class="d-inline">{{ $post['created_at']->diffForHumans() }}</p>
                        </div>

                        <!-- 投稿内容 -->
                        <a href="/post/{{ $post['id'] }}" class="message_content d-block mx-1 text-decoration-none">
                            <p class="text_item">{{ $post['content'] }}</p>
                            </a>
